...
{
    [DbContext(typeof(BlogsAppDbContext))]
    [Migration("20240923220311_AddedEntryCategory")]
    partial class AddedEntryCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogsApp.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BlogsApp.Entries.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlogsApp.Entries.Entry", b =>
                {
                    b.HasOne("BlogsApp.Categories.Category", null)
                        .WithMany()
